"""
Django settings for test_bugbash_42413 project.
...
ROOT_URLCONF = 'test_bugbash_42413.urls'
...
WSGI_APPLICATION = 'test_bugbash_42413.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_bugbash_42413 API",
    "DESCRIPTION": "API documentation for test_bugbash_42413 App",
    "VERSION": "v1",
}
